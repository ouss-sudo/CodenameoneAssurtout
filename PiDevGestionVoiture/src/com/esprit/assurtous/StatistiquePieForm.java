...
public final class StatistiquePieForm extends BaseForm {
  
        
    private boolean drawOnMutableImage;
   
    
    private final double adresse =45;
   // private double nbr_reclamation = 29;
   
    Form current;
BaseForm form;
        public StatistiquePieForm(Resources res)  {
        super("gestion sinistre", BoxLayout.y());
            current= this;
...
//        rbs[0].setSelected(true);
      ...
      /*  RadioButton all = RadioButton.createToggle("adresse", barGroup);
       
        all.setUIID("SelectBar");*/
        RadioButton popular = RadioButton.createToggle("Categorie adresse", barGroup);
        popular.setUIID("SelectBar");
        //RadioButton adresse = RadioButton.createToggle("adresse", barGroup);
        //adresse.setUIID("SelectBar");
  ...
  //;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutVehiculeForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = adresse ;
        
        //values
        double prcntFeed = (adresse *100)/total;
        ...
        //CREATe the chart ...
        PieChart chart = new PieChart(buildDataset("title",Math.round(prcntFeed),Math.round(adresse)), renderer);
